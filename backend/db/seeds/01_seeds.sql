...
('Mercury', 'Your weight on Mercury would be 38% of your weight on Earth.'),
('Venus', 'Venus is named after the Roman goddess of love and beauty.'),
('Earth', 'Earth is mostly iron, oxygen and silicon.'),
('Mars', 'Mars has a volcano called Olympus Mons. Standing a whopping 24 kilometres high, it’s about three times the height of Mount Everest!'),
('Jupiter', 'Jupiter cannot become a star.'),
('Saturn', 'Saturn has only been visited 4 times by spacecraft.'),
('Uranus', 'Uranus is an Ice Giant planet and nearly four times larger than Earth.'),
('Neptune', 'Neptune has the Strongest Winds in the Solar System.'),
('Pluto', 'Pluto was reclassified from a planet to a dwarf planet in 2006.');
